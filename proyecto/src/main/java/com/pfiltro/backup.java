...
public class backup {
    ...
    public backup(ArrayList<Oferta> ofertas) {
        this.ofertas = ofertas;
    }
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Oferta> ofertasrecibidas = new ArrayList<>();
         ...
         while(true){
            ...
            suscriptor.connect("tcp://25.6.14.194:5555"); //IP Empleador 25.6.14.194
            ...
            System.out.println("Oferta recibida: " + mensaje);
                ...
                publicador.bind("tcp://25.6.14.194:4444");  // IP ASPIRANTE
                while(jonas<2){
...
public static  Oferta recibirOfertas(String oferta){
